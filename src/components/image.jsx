  ...
  const fetchImg = async () => {
    try {
      const result = await axios.get(
        `https://api.unsplash.com/photos/${id}?client_id=${process.env.REACT_APP_MOVIE_API}`
      );
  ...
  return (
    <div className='row mb-4 image'>
      ...
      <div className='col-sm-6'>
        ...
        <p className='lead'>Downloads: {image.downloads} </p>
        ...
        <h4 className='mt-3'>Related Collections</h4>
